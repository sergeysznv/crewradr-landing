...
export default function LandingPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center bg-[#F5F4F0] dark:bg-[#1A2327] text-[#1A2327] dark:text-[#EDE8E0] transition-colors duration-300">
      {/* Glow */}
      ...
      <h1 className="relative z-10 text-[clamp(2rem,5vw,3.2rem)] font-bold tracking-[-0.02em]">
        CrewRadr is<br />
        <span className="text-[#6E8679]">coming soon</span>
      </h1>
      ...
      {/* Footer */}
      <div className="fixed bottom-6 text-sm text-[#5A6568] dark:text-[#9AA5A8]">
